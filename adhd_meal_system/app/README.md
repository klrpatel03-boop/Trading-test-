...
| **My pan** | Buy-it-for-life cost-per-use tracker. Logs every cook (auto from Today's cooked-dinner check, or a tap), drives the $250 down through milestones ($5 → $1 → 20¢ / use) with a payoff timeline. |
